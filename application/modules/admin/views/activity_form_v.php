              ...
              <table class="table table-resposive table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <select name="assign" id="assign" class="form-control" required <?= $page == 'readonly' ? 'disabled' : '' ?>>
                      <option value="">--Pilih--</option>
                      <?php foreach ($assign_to->result() as $assign) { ?>
                        <option value="<?= $assign->spv ?>" <?= $assign->spv == $activity->assign ? 'selected' : '' ?>><?= $assign->spv ?></option>
                      <?php } ?>
                    </select>
                  </td>
                </tr>
