            ...
            <div class="box-body">
              <table class="table table-resposive table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-control select2" id="activity" name="activity" <?= $page == 'readonly' || $page == 'update' ? 'disabled' : '' ?>>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <select name="assign" id="assign" <?= $page == 'readonly' ? 'disabled' : '' ?>>
                      <option value="">--Pilih--</option>
                      <?php foreach ($team_sales->result() as $team) { ?>
                        <option value="<?= $team->username ?>" <?= $activity->assign == $team->username ? 'selected' : '' ?>><?= $team->fullname ?></option>
                      <?php } ?>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select class="form-control select2" name="customer" id="customer" <?= $page == 'readonly' || $page == 'update' ? 'disabled' : '' ?>>
                      <option value="">--Pilih--</option>
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-control select2" name="priority" id="priority" <?= $page == 'readonly' || $page == 'update' ? 'disabled' : '' ?>>
                ...
                <?php if ($page != 'create_new') { ?>
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" id="" placeholder="" value="<?= $activity->fullname ?>" readonly>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <div class="box-footer">
                        ...
                        <div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button onclick="kirimKomentar(this)" id="kirim_komentar" class="btn btn-success">Kirim</button>
                          </div>
                        </div>
                      </div>
                    </div>
